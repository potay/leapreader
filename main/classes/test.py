...
## It has nothing to do with the actual application files
#####################################################################
...
def insertFinger(combination, numOfFingers):
    if (numOfFingers < 1):
        return [combination]
    else:
        ...
        for i in xrange(spots):
            ...
            #combinations.append(combination[:i]+[1]+combination[i:])
            combinations += insertFinger(newCombi, numOfFingers-1)
        return set(combinations)

#print insertFinger("0", 2)
